...
const CatalogView = ({ books, onBookClick, onAddBook }: CatalogViewProps) => {
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {filtered.map((book, i) => (
            <div
              ...
              className="group cursor-pointer rounded-xl border border-border bg-card overflow-hidden hover:border-primary/40 hover:shadow-lg transition-all animate-fade-in"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  ...
                  <th className="text-left p-3 font-medium text-muted-foreground hidden md:table-cell">Gênero</th>
                  <th className="text-left p-3 font-medium text-muted-foreground">Status</th>
                  <th className="text-left p-3 font-medium text-muted-foreground hidden sm:table-cell">Nota</th>
                  <th className="text-left p-3 font-medium text-muted-foreground hidden lg:table-cell">Páginas</th>
                </tr>
              </thead>
              <tbody>
                {filtered.map(book => (
